...
?>
<h1 align="center">Questions For Video Clip 04.</h1>

<p></p>
<p></p>
<p></p>
<iframe src="https://bournemouth.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=3d8ffc4b-1715-4682-959a-494f6b1fdac5&v=1" width="720" height="480" style="padding: 0px; border: 1px solid #464646;" frameborder="0"></iframe></p>

<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  

<div class="PageReadableBlue"><p>Question 08</p>
...
<p>What does lack of <?php echo "\""; ?>pins and needles or numbness<?php echo "\""; ?> reduce the likelihood of being the source of symptoms? (Please choose as many as applicable)</p>
...
<p><a href="VideoClip05Questions.php">Next Question.</a></p>
...
$fOutputText = "<strong><p>Question 08</p>";
echo $fOutputText;
fwrite($fp, $fOutputText);}
...
if (isset($PainIndicator3a) && $PainIndicator3a=="Arthrogenic") {
    ...
    $FeedBack = "√ Arthrogenic – please reconsider your answer referring to the information on ‘Description of pain’.";
	$fOutputText .= "\">";
	$fOutputText .= "<p>$FeedBack</p></div>";
	echo $fOutputText;
    fwrite($fp, $fOutputText);}
if (isset($PainIndicator4a) && $PainIndicator4a=="Myogenic") {
	$fOutputText = "<div class=\"";
	$fOutputText .= "PageReadableBrightGreen";
    $FeedBack = "√ Myogenic – please reconsider your answer referring to the information on ‘Description of pain’.";
	$fOutputText .= "\">";
	$fOutputText .= "<p>$FeedBack</p></div>";
	echo $fOutputText;
    fwrite($fp, $fOutputText);}
