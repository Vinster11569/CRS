...
?>
<h1 align="center">Questions For Video Clip 05.</h1>

<p></p>
<p></p>
<p></p>
<iframe src="https://bournemouth.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=d3cb6d89-ffea-4793-b694-eb4156633612&v=1" width="720" height="480" style="padding: 0px; border: 1px solid #464646;" frameborder="0"></iframe></p>

<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  

<div class="PageReadableBlue"><p>Question 09</p></div>
...
<div class="PageReadableBlue"><p>What would you estimate is the severity of the symptoms based on <q>Pain score</q>? (Please choose as many as applicable)</p>
...
<p><a href="VideoClip06Questions.php">Next Question.</a></p>
...
if ((isset($VAS1) && ($VAS1!="")) ||
   ...
   (isset($VAS3) && ($VAS3!="")) ||
   (isset($VAS4) && ($VAS4!=""))){
$fOutputText = "<strong><p>Question 09</p>";
echo $fOutputText;
fwrite($fp, $fOutputText);}
...
if (isset($VAS2) && $VAS2=="Mild") {
    $fOutputText = "<div class=\"";
	$fOutputText .= "PageReadableBrightRed";
    $FeedBack = "X Mild – please reconsider your answer referring to the information on ‘VAS’.";
	$fOutputText .= "\">";
    $fOutputText .= "<p>$FeedBack</p></div>";
	echo $fOutputText;
    fwrite($fp, $fOutputText);}
